...
# -*- coding: utf-8 -*-
import sys
sys.path.append('/home/pi/sketch/Adafruit_Python_GPIO-master')
sys.path.append('/home/pi/sketch/Python_ST7789-master')
...
fontJ = ImageFont.truetype('DejaVuSans.ttf', 14, encoding='unic')
